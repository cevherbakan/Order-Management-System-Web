...
<script>
 $('#seller').addClass("nav-item active");
...
function getData(){ 
    ...
    var token = sessionStorage.getItem('admin_token');
      ...
      $.ajax({
      url: '../methods/getAllSellers.php?key=123',
      dataType: 'json',
      type: 'post',
...
function getLastData(){
    ...
    var token = sessionStorage.getItem('admin_token');
      ...
      $.ajax({
      url: '../methods/getLastSeller.php?key=123',
      dataType: 'json',
      type: 'post',
      contentType: 'application/json',
      data: JSON.stringify( { "admin_id":id ,"admin_token": token} ),
...
$('#add').on( 'click', function () {
      ...
      $.ajax({
      url: '../methods/create-seller.php?key=123',
      dataType: 'json',
      type: 'post',
      contentType: 'application/json',
...
$('#update').on( 'click', function () {
    ...
    console.log(location);
      ...
      $.ajax({
      url: '../methods/updateSeller.php?key=123',
      dataType: 'json',
      type: 'post',
      contentType: 'application/json',
      data: JSON.stringify( { "seller_id":id,"admin_id":admin_id,"admin_token":admin_token,"firstname":name ,"lastname": lastname, "email":email, "phone":phone, "password":password,"location_id":location,"address":address} ),
      processData: false,
      success: function( data, textStatus, jQxhr ){
...
$('#remove').on( 'click', function () {
      ...
      $.ajax({
      url: '../methods/deleteSeller.php?key=123',
      dataType: 'json',
      type: 'post',
      contentType: 'application/json',
      data: JSON.stringify( { "seller_id":id,"admin_id":admin_id,"admin_token":admin_token} ),
      processData: false,
      success: function( data, textStatus, jQxhr ){
